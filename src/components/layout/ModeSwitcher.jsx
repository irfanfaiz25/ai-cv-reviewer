    ...
    <div className="mt-6 flex justify-center space-x-3 sm:space-x-4">
      <button
        ...
        className={`px-4 py-2.5 sm:px-6 rounded-lg font-medium transition-all duration-200 ease-in-out flex items-center
          ${currentMode === 'reviewer' ? 'bg-gradient-to-r from-sky-500 to-cyan-500 text-white shadow-lg scale-105' : 'bg-slate-700 hover:bg-slate-600 text-slate-300'}`}
      >
      ...
      <button
        ...
        disabled={disabled}
        className={`px-4 py-2.5 sm:px-6 rounded-lg font-medium transition-all duration-200 ease-in-out flex items-center
          ${currentMode === 'generator' ? 'bg-gradient-to-r from-emerald-500 to-green-500 text-white shadow-lg scale-105' : 'bg-slate-700 hover:bg-slate-600 text-slate-300'}`}
      >
